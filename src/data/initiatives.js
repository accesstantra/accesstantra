...
const initiatives = [
  ...
  {
    id: 'awareness-hub',
    navLabel: 'Disability Awareness Hub',
    title: 'Disability Awareness Hub',
    tagline: 'Promoting understanding of disability, accessibility and inclusion.',
    status: 'development',
    intro: [
      'Welcome to the Disability Awareness Hub. Thank you for visiting this page. This initiative is currently under development, and our experts and volunteers are working to make it available as soon as possible.',
      'In the meantime, if you require support, guidance, or assistance in this area, please do not hesitate to contact us — we will do our best to assist you or connect you with appropriate resources.',
      'This programme is being developed on a pilot basis. Community interest, participation, and demand will help shape its future continuation and direction. If you believe it can benefit others, we kindly request you to share it within your network.',
    ],
  ...
  {
    id: 'resource-centre',
    navLabel: 'Resource Centre',
    title: 'Resource Centre',
    tagline: 'Accessible resources, guides and toolkits for everyone.',
    status: 'development',
    intro: [
      'Welcome to the Resource Centre. Thank you for visiting this page. This initiative is currently under development, and our experts and volunteers are working to make it available as soon as possible.',
      'In the meantime, if you require support, guidance, or assistance in this area, please do not hesitate to contact us — we will do our best to assist you or connect you with appropriate resources.',
      'This programme is being developed on a pilot basis. Community interest, participation, and demand will help shape its future. If you believe it can benefit others, we kindly request you to share it within your network.',
    ],
    sections: [
      {
        heading: 'Planned resources',
        list: [
          'Assistive technology guides and accessibility toolkits',
          'Educational materials and digital literacy manuals',
          'Legal resources and rights information',
          'Research publications and best-practice documents',
          'Training modules and awareness materials in accessible formats',
        ],
      },
    ],
    ctas: [{ label: 'Contact us', to: '/contact', variant: 'primary' }],
...

  {
    id: 'advocacy',
    navLabel: 'Advocacy',
    title: 'Advocacy for Accessibility',
    tagline: 'Identifying and addressing barriers; asserting rights.',
    intro: [
      'Accessible Tantra works towards identifying and addressing barriers faced by persons with disabilities in education, employment, technology, transportation, healthcare, public services, and community life.',
      'Through this initiative, individuals may report accessibility barriers and seek guidance regarding their rights and available remedies. Wherever feasible, appropriate support, referrals, and pro bono guidance may be provided through experts and volunteers associated with the initiative.',
    ],
    ctas: [{ label: 'Report a barrier or seek guidance', to: '/contact', variant: 'primary' }],
  },

  {
    id: 'community-outreach',
    navLabel: 'Community Outreach',
    title: 'Community Outreach & Door-to-Door Campaigns',
    tagline: 'Reaching individuals directly within their communities.',
    intro: [
      'Many individuals with disabilities and their families remain unaware of available rights, opportunities, services, technologies, and support mechanisms.',
      'To bridge this gap, Accessible Tantra undertakes community-based outreach initiatives, including door-to-door awareness campaigns, local engagement programmes, and grassroots accessibility interventions aimed at reaching individuals directly within their communities.',
    ],
    ctas: [{ label: 'Get involved', to: '/contact', variant: 'primary' }],
  },

  {
    id: 'innovation',
    navLabel: 'Innovation',
    title: 'Innovation & Accessibility Solutions',
    tagline: 'Exploring emerging technology for participation and independence.',
    intro: [
      'Accessible Tantra encourages innovative approaches to accessibility through the exploration of emerging technologies, assistive solutions, inclusive design practices, digital accessibility tools, artificial intelligence applications, and user-centred initiatives.',
      'Our work continues to expand and evolve as we pursue our vision of making every system, every space, and every opportunity accessible for all persons with disabilities.',
    ],
    ctas: [{ label: 'Share an idea or collaborate', to: '/contact', variant: 'primary' }],
  },
]
